    ...
    public struct AccelerationJob : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                ...
                if (posDifference.magnitude>DestinationThreshold) continue;
            ...
            Accelerations[index] += (averageSpread / Count)*Weights.x + (averageVelocity/Count)*Weights.y + (averagePositions/Count - Positions[index])*Weights.z;
        }
    }
}
